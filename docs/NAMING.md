...
| Surface | Pointer |
|---------|---------|
| GitHub work remote | `scrimshawlife-ctrl/Hyperlex` (`main` / this branch) — this file |
| Org mirror | `Zero-State-LLC/Hyperlex` — sync only via intentional `org` push; never train from it |
| Notion Operator Hub | [007 Hyperlexical — Operator Hub](https://app.notion.com/p/3d73e8ba2f5c81ad89d7c2df8e931a83) |
| Notion Spine Owner | [Hyperlex — Spine Owner](https://app.notion.com/p/3d13e8ba2f5c81528452e6bdcc7d8e45) |
| Notion Core Model Spine | [Zero State × Abraxas — Core Model Spine](https://app.notion.com/p/3dc3e8ba2f5c810db2f6f72a8ffe50eb) |
| Public claims DB | [Public Claims & Boundaries](https://app.notion.com/p/ecd794b1226b4dd89abe1ccd928dd35c) |
| README / STATUS / SKILL / glossary | Must cite this split |

## Remotes rule

Working + train remote = **personal** `scrimshawlife-ctrl/Hyperlex`.  
Org `Zero-State-LLC/Hyperlex` is a lagging company mirror. After naming/docs land on personal `main`, an operator may `./scripts/push-org.sh` — do not smash divergent org history.

Peers (Athanor, Semion, Trutina, Yggdrasil, Abraxas) consume this split when they mention Hyperlex products: **ne0l0gist** = ingest; **Hyperlexical** = gated model claim; **Hyperlex** = repo shell.
