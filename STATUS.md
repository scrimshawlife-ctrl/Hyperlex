...
**Version:** 0.4.0  
**Observed:** 2026-09-12  
**Posture:** Hermes skill = current operator surface. Spec 007 = model path (SHADOW). Spark BEST = `seed-morph61` (**PROMOTE** — 0.8451327433628318 ep26 > fair morph60 0.8407079646017699 n=226; E2 PASS). `name_gate` still false.
...
| Spark BEST | **`seed-morph61`** — pin `unbind_exact=0.8451327433628318` (ep26, 191/226) > fair morph60 0.8407079646017699. E2 PASS. Ladder ≥0.55 **HIT**. LAST_TRAINABLE_MAX=8 **HIT**. |
...
| Spec 007 model path (T0→T1) | SHADOW · Spark BEST morph61 (0.8451 ep26 n=226) · fair morph60 0.8407 · E2 PASS · ladder ≥0.55 HIT · LAST=8 MAX · `name_gate` false · no Hub · not named Hyperlexical |
...
1. Spark BEST = **morph61** (held). Observed upsample 6 beat fair morph60: **0.8451327433628318** (191/226) > **0.8407079646017699** (190/226). Do not replay upsample 6 or second-slot weight 3. **In flight:** morph62 `HYPERLEX_UNBIND_OBSERVED_UPSAMPLE=7` (`hlx-train-morph62-1789896471`, exclusive mem 0.3). Fair bar = morph61 pin. See `NEXT_MOVES_007.md` / `receipts/20260920-morph62-observed-upsample7-inflight.md`.
