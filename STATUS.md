...
|------|--------|
| `name_gate` | **false** |
| Spark BEST | **`seed-morph40`** — 0.7368 on n=228. morph43 REJECT (0.9379 < fair 0.9492 n=177). morph44 REJECT (0.9432 < fair 0.9489 n=176). Residual high-conf gold **exhausted** → escalate. |
| Hub publish | **No** |

## Recommended next

1. Spark BEST = **morph40**. morph43/44 REJECT; residual gold exhausted — **escalate**. See `NEXT_MOVES_007.md` and `receipts/20260916-escalate-residual-gold-exhausted.md`.
