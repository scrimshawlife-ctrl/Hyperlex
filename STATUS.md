...
**Version:** 0.4.0  
**Observed:** 2026-09-12  
**Posture:** Hermes skill = current operator surface. Spec 007 = model path (SHADOW). Spark BEST = `seed-morph62` (**PROMOTE** — 0.8495575221238938 ep21 > fair morph61 0.8451327433628318 n=226; E2 PASS). `name_gate` still false.
...
| Spark BEST | **`seed-morph62`** — pin `unbind_exact=0.8495575221238938` (ep21, 192/226) > fair morph61 0.8451327433628318. E2 PASS. Ladder ≥0.55 **HIT**. LAST_TRAINABLE_MAX=8 **HIT**. |
...
| Spec 007 model path (T0→T1) | SHADOW · Spark BEST morph62 (0.8496 ep21 n=226) · fair morph61 0.8451 · E2 PASS · ladder ≥0.55 HIT · LAST=8 MAX · `name_gate` false · no Hub · not named Hyperlexical |
...
1. Spark BEST = **morph62** (held). Observed upsample 7 beat fair morph61: **0.8495575221238938** (192/226) > **0.8451327433628318** (191/226). Do not replay upsample 7 or second-slot weight 3/4. **In flight:** morph63 `HYPERLEX_UNBIND_OBSERVED_UPSAMPLE=8` (`hlx-train-morph63-1789911656`). See `NEXT_MOVES_007.md` / `receipts/20260920-morph63-observed-upsample8-inflight.md`.
