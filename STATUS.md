...
|------|--------|
| `name_gate` | **false** |
| Spark BEST | **`seed-morph40`** — 0.7368 on n=228. morph45 **REJECT_VS_BEST** (0.7237 < fair 0.7368). morph43/44 REJECT. |
| Hub publish | **No** |

## Recommended next

1. Spark BEST = **morph40** (0.7368). morph45 HEAD_SLOT=3 relaunch REJECT. Next lever needs a new justified delta. See `NEXT_MOVES_007.md`.
