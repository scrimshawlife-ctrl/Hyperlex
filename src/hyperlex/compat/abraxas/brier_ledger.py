"""BrierLedgerEntry.v1-compatible dicts (Abraxas core.brier.ledger shape).

Implemented in Hyperlex. No Abraxas import.
"""
...
def compute_ledger_hash(
    ...
    """Match Abraxas BrierLedgerEntry.compute_hash formula."""
...
def to_brier_ledger_entry(
    ...
    *,
    ...
    Fail-closed: only when score["status"] == "SCORED".
    """
