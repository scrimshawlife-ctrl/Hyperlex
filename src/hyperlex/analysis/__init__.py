...
LINEAGE_REGISTRY: List[Dict[str, Any]] = [
    {
        ...
        "terms": [
            ...
            "point-shave",
            # wave6 / operator-blanket-yes:2026-09-10
            "vigorish", "bookie", "bookmaker", "moneyline", "money line",
            "point spread", "teaser bet", "round robin", "same game parlay", "prop bet",
            "proposition bet", "over/under", "over under", "line shopping", "number shopping",
            "beat the close", "devig", "devigging", "no vig", "unit bet",
            "fade the public", "fading the public", "steam ticket", "sharp ticket", "square ticket",
            "public ticket", "dog money", "chalk money", "alt line", "alternate line",
            "player prop", "team total", "puck line", "run line", "futures bet",
            "if bet", "action reverse", "straight bet", "parlay insurance", "buying points",
            "selling points", "listed pitcher", "live betting", "in-play", "betting shop",
            "card counting", "count cards", "crap shoot", "bookie juice", "taking juice",
            "laying juice", "hitting a middle", "middling", "scalping", "scalper",
            "using a beard", "chasing steam", "soft book", "sharp book", "offshore book",
            "closing number", "closing price", "implied probability", "advantage player", "point shave",
            "sucker side", "square side", "freeroll", "free roll", "out of town money",
            "moved off the number", "circled off the board", "dime line", "nickel line", "getting steamed",
            "contrarian bet", "totals bet", "ats bet", "covering the spread", "lay the points",
            "take the points", "arb bet", "arbing", "dutching", "pleaser",
            "teaser card", "f5 ml", "limits raised", "limits lowered", "book limits",
            "hold percentage", "public side money", "sharbing",
],
    ...
    },
    {
        ...
        "terms": [
            ...
            # wave6 / operator-blanket-yes:2026-09-10
            "ser anon", "crypto twitter", "alpha call", "alpha leak", "whale wallet",
            "whale watching", "floor price", "floor sweep", "gas war", "gas fees",
            "airdrop farmer", "farming airdrops", "perp dex", "levered long", "levered short",
            "got liquidated", "liq cascade", "pump and dump", "being exit liquidity", "memecoin season",
            "meme season", "alt season", "heavy bags", "underwater bags", "diamond handing",
            "paper handing", "ngmi ser", "wagmi frens", "dyor nfa", "nfa dyor",
            "lfg ser", "gm ser", "gn frens", "degening", "full degen",
            "degen play", "aping in", "aped the top", "ape the bottom", "jeeted",
            "hopium overdose", "fud campaign", "onchain", "on-chain", "lp position",
            "providing lp", "impermanent loss", "yield farm", "yield farming", "mint sniped",
            "snipe bot", "pfp project", "bluechip pfp", "blue chip nft", "otc desk",
            "bridge hack", "restaking", "points farming", "points meta", "fair launch",
            "stealth launch", "dev wallet", "dev dumped", "liquidity pull", "pulled liquidity",
            "honeypot token", "honeypotted", "renounced ownership", "contract renounced", "based chain",
            "l2 degen", "anon leaks", "anon tip", "spaces alpha", "bullish af",
            "bearish af", "long bias", "short bias", "funding rate", "positive funding",
            "negative funding", "open interest", "oi flush", "stop hunt", "stop hunted",
            "wick down", "wick up", "bag crushing", "crushing bags", "free mint",
            "paid mint", "below floor", "floorless", "unstaking", "staked",
            "premine", "stealth minted", "shitcoining", "jeet paper hands", "probably nothing anon",
            "rugged soft", "hard rug", "bagholdered", "cascade liqs", "ser",
            "anon",
],
    ...
    },
    {
        ...
        "terms": [
            ...
            # wave6 / operator-blanket-yes:2026-09-10
            "abliterate", "abliteration", "abliterated", "agentic AI", "AI psychosis",
            "AI winter", "AIgiarism", "AIpocalypse", "benchmaxx", "chain of thought",
            "chatbot psychosis", "ChatGPT", "cogsucker", "deepfake", "deepfakery",
            "dumb zone", "effective accelerationism", "e/acc", "foom", "Ghiblification",
            "Ghiblified", "Ghiblify", "groksucker", "Groktard", "ignore all previous instructions",
            "LLMism", "neuralese", "tool calling", "vibe coder", "vibe coding session",
            "computer use", "browser agent", "agent swarm", "agent harness", "agent loop",
            "safety refusal", "uncensored model", "prompt leak", "leaked system prompt", "system prompt",
            "context window full", "blew the context window", "slop machine", "slop factory", "clankertown",
            "clanker discourse", "ai generated slop", "ai written slop", "chatgpt energy", "claude coded",
            "copilot suggestion", "rag hallucination", "rag pipeline", "synthetic data slop", "AI notkilleveryoneism",
            "prompt engineered", "prompt eng", "jailbreaking", "jailbreak prompt", "heavy glaze",
            "glazer", "slop content", "slop post", "slopped out", "clanker behavior",
            "clanker take", "model hallucination", "llm hallucination", "agentic coding", "ai agent",
            "sycophantic model", "model sycophancy", "rlhf slop", "tool use loop", "cot reasoning",
            "chatgpt wrote this", "grok take", "grok said", "claude wrote", "midjourney",
            "character.ai", "backchain", "Co-Trained", "derain", "deraining",
            "inpaint", "MLLM", "outpaint", "post-train", "post-trained",
            "pretrain", "pretrained", "prompt crafting", "prompt engineer", "prompt engineering",
            "promptard", "RLAIF", "self-training", "slopaganda", "slopfest",
            "slopgame", "slopification", "slopocalypse", "slopsquatting",
],
    ...
    },
    {
        ...
        "terms": [
            ...
            "it's giving mid",
            # wave6 / operator-blanket-yes:2026-09-10
            "brainrotten", "brizz", "babymaxx", "ballmaxxing", "built different",
            "broscience", "e-boy", "e-girl", "flop era", "dabloon",
            "clock app", "doomscroll", "doomscrolling", "chronically online", "terminally online",
            "midwit", "himothy", "herothy", "we are so back", "it's so over",
            "its so over", "we so back", "algospeak", "corecore", "FYP pull",
            "reel pull", "plug walk", "animation meme", "Fleabag era", "sussy",
            "sussy baka", "rizz god", "w rizz", "l rizz", "aura check",
            "vibe check failed", "passed the vibe check", "yap merchant", "yap session", "stop yapping",
            "npc behavior", "npc walk", "ohio final boss", "only in ohio", "fanum taxed",
            "gooncave", "goon maxxing", "edgelord", "edge lord", "mewing streak",
            "frame mog", "looksmaxxed hard", "delulu coded", "delulu maxxing", "sigma edit",
            "sigma face", "skibidi ohio", "skibidi rizz", "massive gyatt", "gyat",
            "infinite aura", "zero aura", "aura farming hard", "crashout arc", "locked in fr",
            "we locked in", "i'm cooked", "im cooked", "we're cooked", "were cooked",
            "we cooked", "let her cook", "let them cook", "so mid", "mid tier",
            "mid take", "slayed", "slaying", "ate that up", "bussin fr",
            "bussin no cap", "ong fr", "on god bet", "stop capping", "capping",
            "no cap fr fr", "fr fr ong", "no thoughts head empty", "just vibes fr", "periodt queen",
            "iykyk moment", "sheesh moment", "lowkey fire", "highkey mid", "caught lackin",
            "caught lacking", "understood the assignment fr", "left no crumbs fr", "it's giving what", "its giving what",
            "fine shyt energy", "giga chad energy", "gigachad edit", "pure brainrot", "brainrotting",
            "canon event fr", "sybau fr", "404 energy", "you chopped", "looks chopped",
            "aura points lost", "aura points gained", "plus aura fr", "minus aura fr", "negative aura fr",
            "gooner arc", "gooner behavior", "looksmaxxer arc", "copemaxxing hard", "heightmaxxing arc",
            "jestermaxxing arc", "solulu era", "delulu solulu", "unrizzed fr", "rizzless behavior",
            "crashout king", "crashout queen", "aura farmer fr", "main character syndrome fr", "no crumbs left",
            "stop glazing", "glazer behavior", "bet fr", "deadass fr", "kinda sus",
            "ratio + L", "big L", "took the L", "massive W", "big W energy",
            "touch grass fr", "sigma male grindset", "jawline mewing", "looksmaxxing advice", "mogging session",
            "failed the aura check", "yapping in the replies", "brainrot tiktok", "tiktok brainrot", "brainrot compilation",
            "rizzler supreme", "unspoken rizz fr", "locked in sigma", "cooked beyond repair", "schizoposting",
            "based rizz", "midwit take", "grimace shake", "fanum tax fr", "six seven meme",
            "67 meme", "-maxx", "-maxxing", "copemaxxer", "heightmaxxer",
            "its giving mid", "broscientist", "Italian brainrot", "gaslight gatekeep girlboss", "deadass",
],
    ...
    },
    {
        ...
        "terms": [
            ...
            "bruv", "dawg",
            # wave6 / operator-blanket-yes:2026-09-10
            "brochacho", "broham", "broha", "bromigo", "broseph",
            "brosephine", "brotha", "brofist", "broship", "bromance",
            "bromantic", "broette", "bruvver", "bros before hoes", "famalam",
            "homie", "my homie", "yo homie", "yo dawg", "cuzzo",
            "cuzo", "brah", "brudda", "ride or die", "day ones",
            "real ones", "gang gang", "chosen family",
],
        "branch_operator": "sense_extension",
    ...
    },
    {
        ...
        "terms": [
            ...
            "cope seethe",
            # wave6 / operator-blanket-yes:2026-09-10
            "boomersplain", "boomer remover", "black pill", "blue pill", "breadpill",
            "brocialism", "brocialist", "zoomer take", "doomerism", "bloomerism",
            "doomer meme", "bloomer meme", "wagie", "wagies", "wagie life",
            "glowie", "glowies", "glowie detected", "fedposting", "fedpost",
            "janny", "jannies", "janny behavior", "powerjanny", "chud",
            "chuds", "chudjak", "chud behavior", "soyjak", "tradwife",
            "tradcath", "tankie", "tankies", "tankie take", "ancap",
            "neocon", "schizopost", "schizo take", "fed honeypot", "based and whitepilled",
            "based and pinkpilled", "blackpill theory", "redpill theory", "bluepill matrix", "cope and seethe dilate",
            "cope seethe dilate", "dilate harder", "seethe harder", "copium hit", "copium tank",
            "doomer arc", "bloomer arc", "redpilled hard", "blackpilled hard", "bluepilled hard",
            "whitepilled hard", "pinkpill", "pinkpilled hard", "ok boomer", "boomer take",
            "glowie hopium", "chudette", "boomer", "soyjack", "wojak",
            "pepe", "honkler", "ragebait", "shitpost", "dogwhistle",
            "astroturf", "glowpost", "powermod", "jokerfication", "trad",
            "zoomer",
],
        "branch_operator": "irony_inversion",
    ...
    },
    {
        ...
        "terms": [
            ...
            # wave6 / operator-blanket-yes:2026-09-10
            "admin abuse", "aimbot", "aimbotter", "anarchy server", "assrun",
            "blobber", "Blops", "blox", "Bobux", "booter",
            "botted", "bunny hop", "CODBLOPS", "coin-op", "commit die",
            "control point", "corpse camper", "crit out", "damage boost", "danmaku",
            "deagle", "death barrier", "death loop", "death pit", "debuff",
            "debug mode", "demake", "derank", "derust", "despawn",
            "developer exit", "difficulty level", "Easter egg", "eco round", "EOMM",
            "feeder", "flick-screen", "frag movie", "fragfest", "fraggable",
            "freelook", "gank", "gankable", "ganker", "ganking",
            "grief", "griefer", "health point", "in Roblox", "multiblock",
            "noob cannon", "noob toob", "noob tube", "one-trick", "pause buffer",
            "pause buffering", "Pedoblox", "point", "ragequit", "ragequitter",
            "relog", "respawn", "Roblox", "Robloxer", "Robloxian",
            "spawn", "spawn camp", "spawn camper", "spawn point", "spawner",
            "spawnkill", "spawnproof", "stealth nerf", "sweatlord", "team deathmatch",
            "telefrag", "unnerfed", "wallhack", "wallhacker", "wallhacking",
],
        "branch_operator": "platform_compression",
    ...
    },
    {
        ...
        "terms": [
            ...
            # wave6 / operator-blanket-yes:2026-09-10
            "acquihire", "BizDev", "brogrammer", "quiet quitting culture", "acting your wage",
            "performance managed out", "managed out", "bare minimum monday energy", "quiet hiring wave", "oncall",
            "on-call", "stand-up", "all-hands", "skip-level", "hot desk",
            "hiring freeze", "headcount freeze", "open to work", "pip’d", "on a pip",
            "layoff", "reorg", "rightsizing", "c-suite speak", "corp speak",
            "meeting that should have been an email", "this meeting could have been an email", "per my last email", "friendly reminder", "loop me in",
            "action items", "parking lot that", "let’s take this offline", "lets take this offline",
],
        "branch_operator": "sense_extension",
