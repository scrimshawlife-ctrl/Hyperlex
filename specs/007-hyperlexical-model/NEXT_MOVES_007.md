...
| pin | path | note |
|-----|------|------|
| **weight (climb KEEP)** | `~/hlx-private/p1-structure-unbind-famcls46-20260914/` | **KEEP** — N=8 LR 5e-6 aux=0.25 up=8 — **not** BEST |
...
KEEP recipe held; large family lift with structure intact. No BEST promotion.
...
## Policy
OBSERVED hold. No BEST overwrite. Full 40-epoch runs. Human review required before any BEST switch.
