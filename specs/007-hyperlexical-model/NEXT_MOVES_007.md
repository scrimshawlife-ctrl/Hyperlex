...
- Ladder `unbind_exact` ≥ **0.55** still **MISS** (morph36 0.5455; morph37 0.5317)
- **No more schedule clones** without a **new lever** (warm envelope continue alone did not clear 0.55; do not start morph38)

## Policy
OBSERVED hold. Climb KEEP ≠ BEST. Full 40-epoch runs. `name_gate=false`. No morph38 / no schedule clone without new lever.
